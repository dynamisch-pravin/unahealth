...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[680px] lg:min-h-[760px] xl:max-h-[900px] flex items-center overflow-hidden bg-white pt-20">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex items-center py-12 lg:py-16" style={{ zIndex: 1 }}>
